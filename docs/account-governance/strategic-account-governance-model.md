...
- `infohub/realm_profile.yaml` - Account context and metadata
- `infohub/knowledge_index.yaml` - Asset inventory
- `infohub/onboarding_checklist.yaml` - New team member guide
