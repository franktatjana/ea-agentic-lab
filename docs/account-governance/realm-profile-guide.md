...
See the ACME example: `examples/infohub/ACME/realm_profile.yaml`

## Related Documentation

- [Core Entities](core-entities.md) - Realm/Node definitions
- [InfoHub README](../infohub/README.md) - How Realm fits in InfoHub
- [AE Agent Tasks](../teams/account_executives/prompts/tasks.yaml) - Account planning tasks
