...
| PESTLE Analysis | SA Agent | SA Lead | Legal, Compliance | Management |
...
- [Playbook Personalization](../specs/playbook-personalization-spec.md) - Customization system
- [Governance Framework](./governance-framework.md) - Overall governance model
