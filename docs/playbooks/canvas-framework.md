...
infohub/{realm}/{node}/canvas/    # Rendered canvas assets
...
output:
  markdown:
    path: "infohub/{realm}/{node}/canvas/{canvas_type}_{context_id}.md"
  html:
    path: "infohub/{realm}/{node}/canvas/{canvas_type}_{context_id}.html"
...
```yaml
# infohub/{realm}/{node}/canvas/index.yaml
canvases:
...
- [Output Contract](output-contract.md) - Artifact output standards
- [InfoHub Structure](../reference/infohub-structure.md) - Data storage model
