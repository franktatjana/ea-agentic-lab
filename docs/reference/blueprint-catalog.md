...
| ID | Name | Description | Playbooks |
|----|------|-------------|-----------|
| A01_basic | Standard Adoption | Standard new deployment | PB_SA_002, PB_STR_004 |
| A02_enterprise | Enterprise Adoption | Multi-team, multi-environment deployment | PB_SA_002, PB_STR_004, PB_STR_001, PB_VE_001, PB_CA_007 |
...
| ID | Name | Description | Playbooks |
|----|------|-------------|-----------|
| A01_audit_response | Audit Response | Addressing specific audit findings | PB_SA_002, PB_STR_005, PB_STR_004 |
| A02_regulatory | Regulatory Compliance | Meeting regulatory requirements | PB_SA_002, PB_STR_005, PB_STR_004, PB_VE_001 |
...
| ID | Name | Description | Playbooks |
|----|------|-------------|-----------|
| A01_health_recovery | Health Recovery | Address declining health metrics | PB_CA_007, PB_SA_002 |
| A02_champion_rebuild | Champion Rebuild | Re-establish stakeholder relationships | PB_SA_002, PB_CA_007, PB_VE_001 |
...
| ID | Name | Description | Playbooks |
|----|------|-------------|-----------|
| A01_use_case | New Use Case | Expand to adjacent use case | PB_STR_004, PB_STR_001 |
| A02_enterprise | Enterprise Expansion | Scale to additional teams or business units | PB_SA_002, PB_STR_004, PB_STR_001, PB_VE_001 |
...
|-------|-------------------|-------------------|
| **POC** | PB_SA_001 | PB_VE_001, PB_CA_007 |
| **Economy** | PB_SA_002, PB_STR_004 | PB_CI_001 |
| **Premium** | PB_SA_002, PB_STR_004, PB_VE_001, PB_CA_007 | None |
| **Fast Track** | PB_SA_002, PB_STR_004, PB_SA_001 | None |
...
PB_ADM_004 (gap scan) validates that the blueprint instance is complete: all required playbooks executed, all canvases rendered, and success criteria met.
...
| PB_SA_001 | TOGAF ADM (Architecture) | SA Agent | Technical Evaluation, Fast Track |
| PB_SA_002 | Stakeholder Mapping | AE Agent | All archetypes except Technical Evaluation A01 |
| PB_STR_004 | SWOT Analysis | SA Agent | Most archetypes (discovery phase) |
| PB_STR_005 | PESTLE Analysis | AE Agent | Compliance-Driven, optional for others |
