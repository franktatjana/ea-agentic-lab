...
|------|------------|----------|---------|
| **Vault** | Top-level curated asset store containing the Knowledge Base and InfoHub | [vault/](../vault/) | `vault/knowledge/`, `vault/infohub/` |
...
| **InfoHub** | Customer engagement artifacts organized by Realm and Node. Every playbook output lands here with full provenance | [vault/infohub/](../vault/infohub/) | `vault/infohub/ACME/SECURITY_CONSOLIDATION/` |
...
| **Reference Blueprint** | Reusable composition of playbooks/assets for an Archetype + Domain combination. Multiple variants per Archetype (A01-A06) | [blueprints/reference/](../domain/blueprints/reference/) | `ref_security_consolidation.yaml` |
| **Blueprint Instance** | Node-specific instance created from Reference Blueprint, customized for engagement | [vault/infohub/](../vault/infohub/) `{realm}/{node}/blueprint.yaml` | `ACME/SECURITY_CONSOLIDATION/blueprint.yaml` |
| **Playbook** | Small, atomic operational scenario with inputs, steps, outputs (~15-30 min execution) | [executable/](../domain/playbooks/executable/) (strategic), [specialists/](../domain/playbooks/specialists/) (domain), [operational/](../domain/playbooks/operational/) (tactical) | `PB_201_swot_analysis.yaml`, `PB_SEC_001_technical_validation.yaml` |
...
| **Asset** | Instance output produced by playbook execution with provenance | [vault/infohub/](../vault/infohub/) `{realm}/{node}/{category}/` | `ACME/SECURITY_CONSOLIDATION/frameworks/` |
...
| **Gap Scan** | Compliance check comparing Blueprint Instance against Reference Blueprint requirements | Output: [vault/infohub/](../vault/infohub/) `{realm}/{node}/gap_report.yaml` | PB_971 output |
