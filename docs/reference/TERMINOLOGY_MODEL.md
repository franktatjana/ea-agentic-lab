...
| **Playbook** | Small, atomic operational scenario with inputs, steps, outputs (~15-30 min execution) | [strategy/](../../domain/playbooks/strategy/) (strategic), [specialists/](../../domain/playbooks/specialists/) (domain), [operational/](../../domain/playbooks/operational/) (tactical) | `PB_STR_004_swot_analysis.yaml`, `PB_SEC_001_technical_validation.yaml` |
...
| **Gap Scan** | Compliance check comparing Blueprint Instance against Reference Blueprint requirements | Output: `vault/{realm}/{node}/internal-infohub/governance/gap_report.yaml` | PB_ADM_004 output |
