...
|----------|--------|--------|
| PB_SA_001 Discovery & Qualification | Engagement overview, account team contacts | `engagement_overview.md`, `account_team.yaml` |
| PB_SA_002 Stakeholder Mapping | Engagement timeline with decision points | `engagement_timeline.yaml` |
| CL_SA_103 Technical Validation | Validation checklist, success criteria | `architecture/`, `success_criteria.yaml` |
| PB_SA_003 Solution Description | Solution design document, reference architecture | `architecture/` |
| PB_CA_010 Customer Guidelines | Customer-facing guidelines, best practices | `technical-guides/` |
| PB_CA_011 Training Plans | Learning paths, training schedules | `deliverables/` |
