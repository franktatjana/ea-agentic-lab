...
vault/{realm}/{node}/
├── external-infohub/
│   └── journey/adoption_status.yaml    # Adoption tracking
└── internal-infohub/
    ├── governance/health_score.yaml     # Health assessment
    └── risks/risk_register.yaml         # Churn/health risks
```
...
- [Agent Quick Reference](../../architecture/agents/agent-quick-reference.md)
