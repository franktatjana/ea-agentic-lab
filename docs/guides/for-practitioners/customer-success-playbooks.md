...
│  ─────────────────────────          ──────────────────────                  │
│  Security: PB_DEL_005                Discovery: PB_CA_201                    │
│  Observability: PB_DEL_102           Cadence: PB_CA_005                      │
│  Search: PB_DEL_103                  Executive Review: PB_CA_203             │
│                                                                              │
│  HEALTH MANAGEMENT (PB_CA_3xx)      ENABLEMENT (PB_CA_4xx)                  │
│  ──────────────────────────         ─────────────────────                   │
│  Health Triage: PB_CA_006           Technical Workshop: PB_CA_007           │
│  Risk Intervention: PB_CA_302       Migration: PB_CA_008                    │
│  Renewal Protection: PB_CA_303      POV Execution: PB_CA_009                │
│                                                                              │
...
signal_triggers:
  ...
  cadence_call_due:
    playbook: "PB_CA_005_cadence_calls"
...
- [x] `PB_CA_005_cadence_calls.yaml` - Engagement framework
- [x] `PB_CA_006_health_triage.yaml` - Health management
- [x] `PB_DEL_005_security_stage_adoption.yaml` - Stage adoption model
...
- [ ] `PB_CA_007_technical_workshop.yaml`
...
health_triage:
  zone_change: true
  triggers: "PB_CA_005_cadence_calls"
  reason: "Adjust engagement frequency"
```

## Key Playbook Details

### Stage Adoption (PB_DEL_005)
...
- [ ] Health score framework operational (`PB_CA_007_customer_health_score`)
...
- [x] Deploy `PB_CA_005_cadence_calls.yaml`
- [x] Deploy `PB_CA_006_health_triage.yaml`
- [x] Deploy `PB_DEL_005_security_stage_adoption.yaml`
