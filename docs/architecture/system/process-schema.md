  ...
  - step_id: "S1"
    ...
    outputs:
      - artifact: "requirements_list"
        path: "{realm}/{node}/external-infohub/context/rfp/requirements.yaml"
        format: "yaml"
  ...
  - step_id: "S2"
    ...
    outputs:
      - artifact: "security_signoff"
        path: "{realm}/{node}/external-infohub/context/rfp/security_review.md"
        format: "markdown"
  ...
  - step_id: "S3"
    ...
    outputs:
      - artifact: "architecture_proposal"
        path: "{realm}/{node}/external-infohub/architecture/proposal_{date}.md"
        format: "markdown"
        sections:
          - executive_summary
...
outputs:
  ...
  secondary:
    - artifact: "requirements_list"
      path: "{realm}/{node}/external-infohub/context/rfp/"
    - artifact: "security_signoff"
      path: "{realm}/{node}/external-infohub/context/rfp/"
