...
|----------|---------|---------|
| **Strategic** | Framework operationalization, holistic synthesis | PB_STR_004 SWOT Analysis |
...
node:
  ...
  enabled_playbooks:
    strategic: ["PB_STR_001", "PB_STR_004", "PB_VE_001", "PB_CA_007", "PB_CI_001"]
...
node:
  ...
  enabled_playbooks:
    strategic: ["PB_SA_001", "PB_STR_004"]  # TOGAF + SWOT only
...
|-----------|-------|---------|
| Run PB_STR_004 SWOT | Node | SWOT for "Security Consolidation" node |
