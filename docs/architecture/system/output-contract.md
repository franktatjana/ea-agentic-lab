...
**Example:** `2026-01-12_143022_PB_STR_004_c4`

**Components:**
- `YYYY-MM-DD`: Date of execution
- `HHMMSS`: Time of execution (24-hour)
- `playbook_id`: Playbook identifier (e.g., PB_STR_004)
...
```yaml
run_id: "2026-01-12_143022_PB_STR_004_c4"
  ...
  "execution_steps": [
    {
      ...
      "status": "success",
      "details": {
        "playbook_path": "domain/playbooks/PB_STR_004_swot_analysis_v2.yaml",
...
**Run ID:** 2026-01-12_143022_PB_STR_004_c4
**Playbook:** SWOT Analysis (PB_STR_004 v2.0)
...
|-----------|-------|--------|
| high_threat_count | 2 | PB_STR_004_swot |
| low_strength_count | 2 | PB_STR_004_swot |
| min_opportunities | 2 | PB_STR_004_swot |
| min_strengths | 2 | PB_STR_004_swot |
...
*Generated by SA Agent via SWOT Analysis Playbook (PB_STR_004 v2.0)*
*Run ID: 2026-01-12_143022_PB_STR_004_c4*
```
...
run_id: 2026-01-12_143022_PB_STR_002_c4
...
**Framework:** Ansoff Matrix (PB_STR_002)
...
*Generated by AE Agent via Ansoff Matrix Validation Playbook (PB_STR_002 v1.0)*
*Run ID: 2026-01-12_154512_PB_STR_002_c4*
```
...
```
runs/2026-01-12_154512_PB_STR_002_c4/
├── metadata.yaml
├── trace.json
├── report.md
└── outputs/
...
├── 2026-01-12_143022_PB_STR_004_c4/      # SWOT run
│   └── outputs/...
├── 2026-01-12_154512_PB_STR_002_c4/      # Ansoff run
│   └── outputs/...
└── 2026-01-11_091533_PB_STR_004_c4/      # Previous SWOT run
    └── outputs/...
```
...
# Find all SWOT runs
ls runs/ | grep _PB_STR_004_

# Find runs in date range
ls runs/ | grep "^2026-01-1[0-2]"

# Compare two SWOT runs
diff runs/2026-01-11_091533_PB_STR_004_c4/report.md \
     runs/2026-01-12_143022_PB_STR_004_c4/report.md
```
...
```
runs/2026-01-12_160022_PB_STR_004_c4/
