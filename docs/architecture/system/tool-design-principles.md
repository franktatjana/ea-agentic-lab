...
truncation_pattern:
  ...
  full_content_ref: "ACME/SECURITY/internal-infohub/risks/RSK_001.yaml"
...
# In playbook header
best_practices_ref:
  tool_design: "docs/architecture/system/tool-design-principles.md"
  context_engineering: "docs/architecture/system/context-engineering.md"
  evidence_standards: "docs/architecture/playbooks/playbook-execution-specification.md#evidence"
```
...
Main configuration file: [config/tool_design.yaml](../../../domain/catalogs/tool_design.yaml)
