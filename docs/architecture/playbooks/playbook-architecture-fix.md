...
- Created [config/playbook_thresholds.yaml](../../../domain/config/playbook_thresholds.yaml)
...
- Created [config/agent_role_mapping.yaml](../../../domain/mappings/agent_role_mapping.yaml)
