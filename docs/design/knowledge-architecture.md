...
| Vault | Current Location | Status |
|-------|-----------------|--------|
| Customer InfoHub | `vault/infohub/{realm}/{node}/` (mixed) | Needs separation |
| Internal Account Hub | `vault/infohub/{realm}/{node}/` (mixed) | Needs separation |
| Global Knowledge Vault | `vault/knowledge/` | Exists |
