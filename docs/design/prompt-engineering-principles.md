...
react_pattern: |
  ...
  Action: read_artifact(artifact_path="infohub/{realm}/tech_signal_map/current_map.yaml")
...
few_shot_examples:
  - example_id: "risk_high_competitive"
    ...
    output: |
      ...
      evidence:
        - source: "infohub/ACME/SECURITY/meetings/2026-01-15.md"
...
reflexion:
  ...
  components:
    ...
    memory:
      ...
      long_term: infohub/{realm}/agent_work/reflections/
```
  ...
  reflection_process:
    ...
    - step: update_guidance
      action: |
        ...
        infohub/patterns/win_patterns.yaml
        infohub/patterns/loss_patterns.yaml
...
- [Playbook Execution Specification](playbook-execution-specification.md) - How playbooks run
- [Agent Architecture](agent-architecture.md) - Agent responsibilities
