...
See: [Example Scratchpad](../../examples/infohub/ACME/SECURITY_CONSOLIDATION/agent_work/scratchpad_sa_2026-01-22_displacement_analysis.yaml)
...
Main configuration file: [config/context_engineering.yaml](../../config/context_engineering.yaml)
...
- [Playbook Execution](playbook-execution-specification.md) - Task execution
