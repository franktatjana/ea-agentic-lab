...
```json
{
  ...
  "artifacts": {
    "report_path": "vault/infohub/ACME/SECURITY_CONSOLIDATION/frameworks/SWOT_2026-02-03.md",
    "data_path": "vault/infohub/ACME/SECURITY_CONSOLIDATION/frameworks/SWOT_2026-02-03.yaml"
  }
}
```
