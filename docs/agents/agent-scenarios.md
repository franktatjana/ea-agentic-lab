...
│                                                                              │
│ 1. infohub/acme/security_consolidation/risks/risk_register.yaml             │
...
│                                                                              │
│ 2. infohub/acme/security_consolidation/architecture/adr/                    │
│    + ADR-2024-012-capacity-review.md created                                │
│    + Status: "Investigation Required"                                       │
│    + Context: Current cluster sizing vs actual workload                     │
│                                                                              │
│ 3. infohub/acme/security_consolidation/actions/action_tracker.yaml          │
...
│ INFOHUB UPDATES (Automatic)                                                  │
│                                                                              │
│ 1. infohub/global_mfg/expansion/risks/risk_register.yaml                    │
...
│ INFOHUB UPDATES (Automatic)                                                  │
│                                                                              │
│ 1. infohub/finserv/soc_consolidation/product/feature_requests.yaml          │
...
│                                                                              │
│ 2. infohub/finserv/soc_consolidation/risks/risk_register.yaml               │
...
│                                                                              │
│ 3. infohub/finserv/soc_consolidation/decisions/decision_log.yaml            │
...
│ INFOHUB UPDATES (Automatic)                                                  │
│                                                                              │
│ infohub/techcorp/phase2/meetings/2024-01-15-steering.md                     │
│ + Full meeting notes archived                                               │
│ + Linked: DEC-2024-0156, DEC-2024-0157, RSK-2024-0050                       │
│ + Linked: ACT-2024-0201, ACT-2024-0202                                      │
│                                                                              │
│ infohub/techcorp/phase2/decisions/decision_log.yaml                         │
│ + 2 new decisions registered                                                │
│                                                                              │
│ infohub/techcorp/phase2/risks/risk_register.yaml                            │
│ + 1 new risk registered                                                     │
│                                                                              │
│ infohub/techcorp/phase2/actions/action_tracker.yaml                         │
│ + 2 new actions tracked                                                     │
│                                                                              │
│ infohub/techcorp/phase2/governance/open_questions.yaml                      │
