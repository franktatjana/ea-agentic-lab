...
|----------|---------|-------|
| **Strategic** | Execute customer-facing work | 15 |
...
| **InfoHub Path** | `infohub/{realm}/{node}/commercial/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/architecture/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/customer_architecture/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/competitive/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/value/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/leadership/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/rfp/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/poc/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/security/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/delivery/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/services/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/support/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/partners/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/product/` |
...
| **InfoHub Path** | `infohub/{realm}/{node}/specialists/` |
...
|---------|-------|
| **Output Path** | `infohub/{realm}/{node}/meetings/` |
...
|---------|-------|
| **Output Path** | `infohub/{realm}/{node}/actions/` |
...
|---------|-------|
| **Output Path** | `infohub/{realm}/{node}/decisions/` |
...
|---------|-------|
| **Output Path** | `infohub/{realm}/{node}/nudges/` |
...
|---------|-------|
| **Output Path** | `infohub/{realm}/{node}/risks/` |
...
|---------|-------|
| **Output Path** | `infohub/{realm}/{node}/reports/` |
...
**Reads From:**
- `infohub/{realm}/{node}/` - all subdirectories (architecture, decisions, risks, etc.)
...
message:
  ...
  payload:
    artifact_path: "infohub/ACME/SECURITY_CONSOLIDATION/architecture/design_v1.md"
