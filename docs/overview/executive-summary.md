...
order: 1
audience: both
summary: "One-page what the platform does, for whom, and how the lifecycle works."
related:
  - ../HANDBOOK.md
  - ../START_HERE.md
---
...
Sample customers and the ACME demo engagement live under `vault/` in the repository (paths in [Repository path locator](../reference/repository-paths.md#demo-and-sample-vault-acme)). The in-app documentation browser only renders `docs/`; open those folders in your editor or GitHub to browse YAML and vault data.
...
| Topic | Link |
|-------|------|
| User handbook | [Handbook](../HANDBOOK.md) |
| Terminology and concepts | [Terminology Model](../reference/TERMINOLOGY_MODEL.md) |
| YAML locations (archetypes, tracks, blueprints, vault) | [Repository path locator](../reference/repository-paths.md) |
| Agents | [Agent architecture](../architecture/agents/agent-architecture.md), [Responsibilities](../architecture/agents/agent-responsibilities.md) |
| Playbooks | [Playbook system](../architecture/playbooks/playbook-system.md), [Catalog](../reference/playbook-catalog.md) |
| Canvases | [Canvas framework](../architecture/playbooks/canvas-framework.md) |
| Knowledge architecture | [Vault architecture](../architecture/system/vault-architecture.md), [Knowledge lifecycle](../architecture/system/knowledge-lifecycle.md) |
| Learning system | [Checklist learning](../architecture/system/checklist-learning-system.md) |
| Operating model | [RACI model](../operating-model/raci-model.md), [Operating model](../operating-model/README.md) |

**Next:** [User handbook](../HANDBOOK.md) for role-based workflows, or [Start here](../START_HERE.md) to pick another track.
