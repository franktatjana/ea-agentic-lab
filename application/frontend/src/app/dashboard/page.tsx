          ...
          <div className="flex items-center gap-3 text-xs">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <HelpPopover title="QBR Readiness">
                Percentage of preparation checklist items completed. Maps to PB_AE_003 quarter-long cadence across 4 phases.
              </HelpPopover>
            </div>
            <div className="flex items-center gap-1">
              <div className={cn(
          ...
          <div>
            <div className="flex items-center gap-1 mb-2">
              ...
              <HelpPopover title="Prior QBR Commitments">
                Action items from the previous QBR with current status. Every item must have an owner and deadline. Blocked items must include a reason. Items past deadline without completion are flagged. 2+ blocked commitments triggers a warning alert in PB_AE_003.
              </HelpPopover>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <div className="flex items-center gap-1 mb-2">
              ...
              <HelpPopover title="Signals & Risks">
                Active risks, competitive encounters, and PB_AE_003 decision rules triggered this quarter. Types: Pipeline Risk, Competitive, Forecast, Account Health, Stalled Deal. Sorted by severity. PB_AE_003 defines 8 decision rules that auto-generate signals, for example: pipeline below 2x, repeated losses to same competitor, 3+ stalled deals.
              </HelpPopover>
            </div>
            <div className="border rounded-md overflow-hidden">
              <table className="w-full text-xs">
          ...
          <div>
            <div className="flex items-center gap-1 mb-2">
              ...
              <HelpPopover title="QBR Readiness">
                Preparation checklist mapped to PB_AE_003 quarter-long cadence. Wk 1-4: foundation (targets, baseline pipeline). Wk 5-8: continuous capture (health scores, competitive encounters, win/loss retrospectives). Wk 9-12: synthesis (MEDDPICC assessments, pipeline snapshot, narrative). Pre-QBR: alignment sync with SA, CA, CI, VE agents. GREEN {"\u2265"} 80%, YELLOW 50-79%, RED {"<"} 50%.
              </HelpPopover>
            </div>
