...
const CATEGORY_TABS: CategoryTab[] = [
  ...
  { category: "Leadership", label: "Leadership", icon: Briefcase, color: "text-amber-400", border: "border-l-amber-400", summary: "Sales leadership stack: team coaching, revenue strategy, forecast governance, and revenue operations." },
